...
labeled_id_path=splits/$dataset/labeled/train_merge_IRSAMap.txt
unlabeled_id_path=splits/$dataset/unlabeled/SARLO.txt
save_path=exp/$method/$backbone/labeled_mota_ms_merge_IRSAMap_lr5e_5/   # backbone 自动加入路径
