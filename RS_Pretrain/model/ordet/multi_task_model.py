...
class ORCNN(torch.nn.Module):
    ...
    def forward(self, x, data_sample=None, mask_ratio=0.0):
        h, w = x.shape[-2:]
        # e = self.encoder.get_intermediate_layers(x, n=self.intermediate_layer_idx['base'])
