...
imgs_directory1 = os.path.join(instance_base_directory, 'labeled/MOTA/split_ss_dota1_0/val/images/')
masks_directory1 = os.path.join(instance_base_directory, 'labeled/MOTA/split_ss_dota1_0/val/labelTxt/')

output_file = '/data1/users/zhengzhiyu/ssl_workplace/S5_fulll/S4_Pretrain/splits/pretrian_det/labeled/val_mota_ss.txt'
