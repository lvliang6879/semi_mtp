...
CLASSES = {'pascal': ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 
        ...
        #    'instance': ['large_Vehicle', 'swimming_pool', 'helicopter', 'bridge','plane', 'ship', 
        ...
        #                 'baseball_diamond', 'tennis_court','roundabout', 'storage_tank', 'harbor', 'background'],
         ...
         #   'pretrain_mt': ["large_Vehicle", "swimming_pool", "helicopter", "bridge", "plane",
        ...
        #    'isaid': ['Impervious_Surface', 'Building', 'Low_Vegetation', 'Tree', 'Car'],
