...
method='main_finetune_cpu_rsseg_four'  # 主训练脚本名（不含 .py）
# exp='vit_b_moe_wo_shared_upernet_s5'
# exp='vit_b_rvsa_moe_upernet_s5'
# exp='vit_l_moe_upernet_s5'
# exp='vit_h_moe_upernet_s5'
exp='vit_l_moe_upernet_s5'
...
uavid_id_path=splits/uavid/$split/labeled.txt

# 模型保存路径
save_path=exp/$dataset/$method/$exp/$split/part_256_batch_12_last30_vai_loss/
mkdir -p $save_path
