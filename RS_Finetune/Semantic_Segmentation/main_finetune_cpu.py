...
parser.add_argument('--resume', type=str,  default='/data1/users/zhengzhiyu/ssl_workplace/S5_fulll/S4_Pretrain/exp/semi_mtp/dinov3_vit_b/labeled_mota_ms_merge_IRSAMap/dinov3_vit_b_obb_iter_20000.pth', help='resume name')
# parser.add_argument('--resume', type=str,  default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep/pretrained/semi_sep/vit_h/vit_h_upernet_miou_69.3_semi_sep_11.5k.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep2/exp/pretrain/semi_sep/R3B_S_upernet_mae/millionseg_1000k_vit_h/R3B_S_upernet_semi_sep_iter_240000.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep/pretrained/semi_sep/vit_b/rf_vit_b_upernet_swinl_to_vit_b_sep_iter_80000.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep2/exp/pretrain/s5_fixmatch/vit_b_upernet_mae/MillionAID/vit_b_upernet_iter_80000.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/S5_fulll/S4_Pretrain/exp/s4p_mae_adaptive/vit_mae_b/s4p_mae_adaptive/vit_mae_b_s4p_upernet.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep2/exp/pretrain/supervised_pretrain/vit_b_upernet_mae/isaid/latest.pth', help='resume name')
# parser.add_argument('--resume', type=str, default='/data1/users/zhengzhiyu/ssl_workplace/semi_sep2/exp/pretrain/s5_fixmatch/vit_b_upernet_mae/Millionseg_lr5e-5/vit_b_upernet_iter_100000.pth', help='resume name')
